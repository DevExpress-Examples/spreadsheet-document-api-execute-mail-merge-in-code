...
Namespace EmployeeInfo
    ...
    Public Module EmployeesInfo
        ...
        Public Function GetData() As IEnumerable(Of EmployeeInfo.EmployeeInfo)
            Return EmployeeInfo.DataSourceHelper.GetDataSouresFromXml(Of EmployeeInfo.EmployeeInfo)("EmployeeInfo.data.xml", "ArrayOfEmployeeInfo")
        End Function
    End Module
    ...
    Public Module DataSourceHelper
        ...
        Public Function GetDataSouresFromXml(Of T As Class)(ByVal resName As String, ByVal attribute As String) As List(Of T)
            Using stream As Stream = Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream(resName)
                Dim s As XmlSerializer = New XmlSerializer(GetType(List(Of T)), New XmlRootAttribute(attribute))
        ...
        Public Property PictureByteArray As Byte()
            Get
                If Photo IsNot Nothing Then
                    ...
                    Return CType(BitmapConverter.ConvertTo(Photo, GetType(Byte())), Byte())
                Else
                    Return Nothing
                End If
            End Get
